...
<div class="container-fluid">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            ...
            <p class="mb-0 text-muted">Edit data jurusan: {{ $major->name }}</p>
        </div>
                ...
                <div class="row">
                            ...
                            <select name="head_of_major_id" id="head_of_major_id" 
                                ...
                                @forelse($teachers as $teacher)
                                    <option value="{{ $teacher->id }}" 
                                            {{ old('head_of_major_id', $major->head_of_major_id) == $teacher->id ? 'selected' : '' }}>
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="number" name="capacity" id="capacity" value="{{ old('capacity', $major->capacity) }}" 
                                   class="form-control @error('capacity') is-invalid @enderror"
                                   min="1" required>
                            @error('capacity')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                            <div class="form-text">Kapasitas total siswa untuk jurusan ini</div>
                        </div>
                    </div>
                    ...
                    <div class="col-12">
                        <div class="mb-3">
                            ...
                            <textarea name="description" id="description" rows="3" 
                                      ...
                                      placeholder="Deskripsi singkat tentang jurusan ini">{{ old('description', $major->description) }}</textarea>
                            @error('description')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
